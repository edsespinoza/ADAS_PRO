...
CREATE TABLE IF NOT EXISTS public.rate_limits (
  ...
  window_start timestamptz NOT NULL,   -- início da janela atual (1 min)  ('window' é palavra reservada)
...
COMMENT ON COLUMN public.rate_limits.window_start IS 'Início da janela de 1 minuto';
